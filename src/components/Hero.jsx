    ...
    <section className="relative w-full h-screen mx-auto">
      ...
      >
        <div className="flex flex-col justify-center items-center mt-5">
          ...
          <div className="w-0.5 sm:h-80 h-40 bg-gradient-to-t from-indigo-500 via-violet-600 to-blue-700" />
        </div>
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span id="changeText" className="text-[#915eff]">Umrao</span>
          </h1>
